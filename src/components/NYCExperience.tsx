...
export default function NYCExperience() {
  ...
  const standards = [
    ...
    },
    {
      ...
      text: 'Über 500 exklusive Gel- & Chrome-Farben direkt inspiriert von den Laufstegen in NYC.'
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight mb-5">
            Das 4-Stufen-Ritual für <span className="text-[#c5a059] italic font-serif">makellose Nägel</span>
          </h2>
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-5">
                  <span className="text-3xl font-extrabold font-mono text-[#c5a059]/40 group-hover:text-[#c5a059] transition-colors">
                    {step.num}
                  </span>
                  <span className="text-[11px] font-semibold uppercase tracking-wider px-2.5 py-1 rounded bg-white/5 text-slate-300 border border-white/10">
                    {step.badge}
                  </span>
                </div>
                
                <h3 className="text-lg font-bold text-white mb-1.5 group-hover:text-[#dfb76c] transition-colors">
                  {step.title}
                </h3>
                <p className="text-xs font-medium text-[#c5a059] uppercase tracking-wider mb-3">
                  {step.subtitle}
                </p>
              ...
              <div className="pt-6 mt-6 border-t border-white/5 flex items-center justify-between text-xs text-slate-400 group-hover:text-white transition-colors">
