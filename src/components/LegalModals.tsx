...
export default function LegalModals({ type, onClose }: LegalModalsProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-12 animate-in fade-in duration-200 font-sans">
      ...
      />
      <div 
        className="relative w-full max-w-3xl max-h-[85vh] bg-white border border-stone-200 text-stone-800 rounded-3xl shadow-2xl flex flex-col z-10"
        role="dialog"
        aria-modal="true"
      >
        ...
        <div className="p-6 sm:p-8 overflow-y-auto overscroll-contain text-stone-600 text-sm leading-relaxed space-y-4">
          {type === 'impressum' ? (
            <>
              <h3 className="font-display font-semibold text-stone-900 text-lg">Angaben gemäß § 5 DDG</h3>
              <p>
              ...
              <h4 className="font-display font-semibold text-stone-900 text-base pt-2">Kontakt</h4>
              <p>
              ...
              <h4 className="font-display font-semibold text-stone-900 text-base pt-2">Gewerbeanmeldung</h4>
              <p>
                Gewerbeanmeldung nach § 14 GewO erteilt durch die Stadt Kerpen.
              </p>

              <h4 className="font-display font-semibold text-stone-900 text-base pt-2">Verbraucherstreitbeilegung / Universalschlichtungsstelle</h4>
              <p>
            ...
            <>
              <h3 className="font-display font-semibold text-stone-900 text-lg">Datenschutzerklärung</h3>
              <p>
              ...
              <h4 className="font-display font-semibold text-stone-900 text-base pt-2">1. Verantwortliche Stelle</h4>
              <p>
              ...
              <h4 className="font-display font-semibold text-stone-900 text-base pt-2">2. Datenerfassung auf dieser Website</h4>
              <p>
              ...
              <h4 className="font-display font-semibold text-stone-900 text-base pt-2">3. Ihre Rechte</h4>
              <p>
