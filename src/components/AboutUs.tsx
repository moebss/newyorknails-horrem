      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#c5a059]/10 border border-[#c5a059]/30 text-[#c5a059] text-xs font-sans font-semibold uppercase tracking-widest">
            ...
            <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-normal text-white tracking-normal leading-tight">
              Manhattan Spirit. <br />
              <span className="italic text-[#c5a059]">Persönliche Meisterkunst.</span>
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2 font-sans">
              <div className="bg-[#141722] border border-white/10 p-5 rounded-2xl">
                <span className="font-display font-semibold text-white block text-base">Adresse</span>
                <span className="text-xs text-slate-300 block mt-1.5 leading-relaxed">
                  Hauptstraße 177–179<br />50169 Kerpen-Horrem
                </span>
              </div>
              <div className="bg-[#141722] border border-white/10 p-5 rounded-2xl">
                <span className="font-display font-semibold text-white block text-base">Öffnungszeiten</span>
                <span className="text-xs text-slate-300 block mt-1.5 leading-relaxed">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2 font-sans">
              <a
                ...
                className="inline-flex items-center gap-2 bg-[#c5a059] hover:bg-[#dfb76c] text-[#0b0c10] text-xs font-bold uppercase tracking-wider py-3.5 px-6 rounded-xl shadow-lg transition-all"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-white/5 hover:bg-white/10 text-white text-xs font-medium py-3.5 px-6 rounded-xl border border-white/10 transition-colors"
              >
          ...
          <div className="lg:col-span-6 relative rounded-3xl overflow-hidden shadow-2xl border border-white/10 aspect-[4/3] bg-[#141722]">
            ...
            <div className="absolute bottom-6 left-6 right-6 p-4 rounded-xl bg-[#0b0c10]/80 backdrop-blur-md border border-white/10 text-xs text-slate-200 font-sans">
